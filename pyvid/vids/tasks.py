...
def convert_video(video_id):
    ...
    cmd = """
        ffmpeg -i %s \
            -codec:v libx264 -tune zerolatency -profile:v high -preset veryfast -crf 23 -maxrate 1000k -bufsize 10000k -vf scale="trunc(oh*a/2)*2:720" -codec:a libfdk_aac -pix_fmt yuv420p -movflags +faststart -threads 0 %s \
